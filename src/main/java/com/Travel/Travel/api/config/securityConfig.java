...
public class securityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        //ENTRADA DE AUTENTIFICACION -----> /LOGIN
    ...
    //COMO SE VA ENCRIPTAR Y DESENCRIPTAR
    @Bean
    ...
    public RegisteredClientRepository registeredClientRepository(BCryptPasswordEncoder encoder) {
        var registeredClient = RegisteredClient
                ...
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)//tipo de autentificacion basic
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)// codigo de autentificacion|
                .build();
    ...
    //convierte el rol prefijo SCOPE del rol
    @Bean
